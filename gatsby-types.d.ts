...
type articleListQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly excerpt: string | null, readonly timeToRead: number | null, readonly frontmatter: { readonly date: string | null, readonly title: string | null, readonly slug: string | null, readonly tags: ReadonlyArray<string | null> | null } | null }> } };
...
type PostsByIDQueryVariables = Exact<{
  id: Scalars['String'];
}>;
...
type AllArticlesQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly slug: string | null } | null } }> } };
