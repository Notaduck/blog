...
const Index: FC<PageProps<null, null, { scrollToContact: boolean }>> = ({
  location,
}) => {
    ...
    <Layout>
      ...
      <Section id={SECTIONS.ABOUT} to={SECTIONS.CONTACT} btnText="Get in touch">
        <div className="font-montserrat w-10/12 mx-auto my-auto md:mt-12 flex justify-center align-middle flex-col dark:prose-invert prose ">
          <h2
            className="md:text-3xl sm:text-2xl text-2xl mt-5 mb-10 font-black"
            role="heading"
            aria-level="2"
          >
            Who am I?
          ...
          <p className="mb-4">
            My name is Daniel Guldberg Aaes, and I am{" "}
            {calculateAge("1991-07-02")} years old, with a bachelor’s degree in
            Software Development from the IT University of Copenhagen in
            Denmark.
          </p>

          <p>
            Initially, I started out in the social and healthcare profession and
            worked there for a couple of years. However, I had always been in
            doubt if I wanted to work with people or in the tech industry due to
            my fear of turning a hobby into work and losing the joy within it.
            At some point, I decided to transition my career from the social and
            healthcare field to technology.
          </p>
          ...
          <p className="mb-4">
            Throughout the last couple of years, I have gained experience with
            various programming languages in different domains such as Java,
            Python, C, C#, F#, JavaScript, and so on. Most of the knowledge I
            have gained is from spending countless hours reading documentation,
            using Google, and reading a ton of online tutorials and guides. I
            feel that I now have enough experience to pass on this knowledge
            while also learning a lot by creating these blog posts, as it forces
            me to reflect on my acquired knowledge, which often leads to flaws
            that I must address.
          </p>
        </div>
      </Section>
