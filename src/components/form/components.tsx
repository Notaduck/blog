...
export const Input: FC<TInput> = ({ register, name, type, error, label }) => (
...
export const TextArea: FC<TTextArea> = ({ register, name, error, label }) => (
...
export const Row = ({ children }) => (
  <div className="flex space-x-2 xs:flex-col sm:flex-row w-full">
    {" "}
    {children}{" "}
  </div>
);
